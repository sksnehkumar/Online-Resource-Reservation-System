...
+(function(window, angular, undefined){
  ...
  mfb.run(['$templateCache', function($templateCache) {
    ...
    '       ng-attr-data-mfb-label="{{label}}" class="mfb-component__button--main" style="background-color:{{bgcolor}};color:{{fgcolor}}">' +
    ...
    '  <li class="mfb-component__wrap">' +
    '    <a ng-click="clicked()" ng-mouseenter="hovered()" ng-mouseleave="hovered()"' +
    '       style="box-shadow: none; background-color:{{bgcolor}};color:{{fgcolor}}"' +
    ...
    '<li>' +
    '  <a data-mfb-label="{{label}}" class="mfb-component__button--child" style="background-color:{{bgcolor}};color:{{fgcolor}}">' +
